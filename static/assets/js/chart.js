...
var chart = AmCharts.makeChart("chartdiv2", {
  ...
  chartScrollbarSettings: { graph: "g1", usePeriod: "10mm", position: "top" },
  ...
  periodSelector: {
    ...
    periods: [
      ...
      { period: "hh", count: 5, selected: true, label: "5 hour" },
...
var chart = AmCharts.makeChart("chartdiv4", {
  ...
  valueAxes: [
    { id: "v1", axisAlpha: 0, position: "left", ignoreAxisWidth: true },
  ],
...
var chart = AmCharts.makeChart("chartdiv3", {
  ...
  arrows: [
    { color: "#67b7dc", innerRadius: "20%", nailRadius: 0, radius: "85%" },
  ],
  export: { enabled: true },
});
